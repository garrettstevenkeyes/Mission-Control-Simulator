...
export const guidedLabs: GuidedLabDefinition[] = [
  {
    ...
    watch: ["Round trip", "Command trace", "Solid machine vs faded view"],
  ...
  },
  {
    ...
    steps: ["Load the high-jitter setup.", "Send Left, Right, and Stop in quick succession.", "Compare command ages in System details."],
  ...
  },
  {
    ...
    watch: ["Dropped packet count", "Trace outcome", "Newest telemetry"],
  ...
  },
  {
    ...
    watch: ["Command age", "Edge check", "Stale command count"],
